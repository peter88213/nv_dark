[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v0.8.2.pyz)
...
Download the latest release [nv_dark_v0.8.2.pyz](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v0.8.2.pyz)

- Launch *nv_dark_v0.8.2.pyz* by double-clicking (Windows desktop),
- or execute `python nv_dark_v0.8.2.pyz` (Windows), resp. `python3 nv_dark_v0.8.2.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_dark_v0.8.2.zip](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v0.8.2.zip)

- Extract the *nv_dark_v0.8.2* folder from the downloaded zipfile "nv_dark_v0.8.2.zip".
