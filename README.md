[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v5.0.3.pyz)
...
Download the latest release [nv_dark_v5.0.3.pyz](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v5.0.3.pyz) (67 KB)

- Launch *nv_dark_v5.0.3.pyz* by double-clicking (Windows desktop),
- or execute `python nv_dark_v5.0.3.pyz` (Windows), resp. `python3 nv_dark_v5.0.3.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_dark_v5.0.3.zip](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v5.0.3.zip) (68 KB)

- Extract the *nv_dark_v5.0.3* folder from the downloaded zipfile "nv_dark_v5.0.3.zip".
