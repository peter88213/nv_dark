[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v0.4.0.pyzw)
...
Download the latest release [nv_dark_v0.4.0.pyzw](https://github.com/peter88213/nv_dark/raw/main/dist/nv_dark_v0.4.0.pyzw)

- Launch *nv_dark_v0.4.0.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_dark_v0.4.0.pyzw` (Windows), resp. `python3 nv_dark_v0.4.0.pyzw` (Linux) on the command line.
